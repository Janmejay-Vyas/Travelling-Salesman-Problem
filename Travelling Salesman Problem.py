"""
An example of using genetic algorithm to obtain an optimal solution to a problem
"""
import random
import sys
import math
...
TotalNum = 20 # Total number of destinations
popNum = 5000
...
def main():
    ...
    print(f"Time taken for execution: {time.time() - start_time}s")
    best.display()
    pygame.display.update()
